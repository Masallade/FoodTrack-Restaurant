...
import 'package:stackfood_multivendor_restaurant/firebase_options.dart';
...
// This line initializes a FlutterLocalNotificationsPlugin instance, which is used for displaying local notifications within the app.
Future<void> main() async {
  ...
  Get.put(DinningController());
  WidgetsFlutterBinding.ensureInitialized();
  await Firebase.initializeApp(
    options: DefaultFirebaseOptions.currentPlatform, // For Web support
  );
