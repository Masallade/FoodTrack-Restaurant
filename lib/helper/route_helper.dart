...
import 'package:stackfood_multivendor_restaurant/features/addOrder/screens/foodlist.dart';
...
import 'package:stackfood_multivendor_restaurant/features/dinning/dinning_main_screen.dart';
...
import '../features/restaurant/widgets/product_view_widget.dart';
...
class RouteHelper {
  ...
  static const String addOrder='/PosScreen';
  ...
  static String getAddOrderRoute()=> addOrder;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: addOrder, page: ()=>const DinningMainScreen())
  ];
}