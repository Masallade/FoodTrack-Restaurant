                    ...
                    child: SingleChildScrollView(
                      ...
                      child: SizedBox(
                        ...
                        child: Column(children: [
                          ...
                          Visibility(
                            ...
                            child: Column(children: [
                              ...
                              // ListView.builder(
                              //    itemCount: _languageList!.length-3 ?? 0,
                              //   shrinkWrap: true,
                              ...
                              Padding(
                                padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraLarge),
                                child: CustomTextFieldWidget(
                                  hintText: '${'restaurant_name'.tr} (${_languageList![0].value!})',
                                  controller: _nameController[0],
                                  focusNode: _nameFocus[0],
                                  nextFocus: 0 != _languageList.length-1 ? _nameFocus[0+1] : _addressFocus[0],
                                  inputType: TextInputType.name,
                                  capitalization: TextCapitalization.words,
                                ),
                              ),
                              ...
                              // ListView.builder(
                              //   itemCount: _languageList.length-3,
                              //   shrinkWrap: true,
                              //   physics: const NeverScrollableScrollPhysics(),
                              //   itemBuilder: (context, index) {
                              //     return Padding(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraLarge),
                          child: CustomTextFieldWidget(
                            hintText: '${'restaurant_address'.tr} (${_languageList[0].value!})',
                            controller: _addressController[0],
                            focusNode: _addressFocus[0],
                            nextFocus: 0 != _languageList.length-1 ? _addressFocus[0+1] : _vatFocus,
                            inputType: TextInputType.text,
                            capitalization: TextCapitalization.sentences,
                            maxLines: 3,
                          ),
                        ...
                        for (Data data in authController.dataList!) {
                          ...
                          if(isTextField) {
                            ...
                            if (customFieldEmpty && isRequired) {
                              showCustomSnackBar(
                                  '${'please_set_data_in'.tr} ${authController
                                      .dataList![index].inputData!.replaceAll(
                                      '_', ' ')} ${'field'.tr}');
                              break;
                            } else {
                      ...
                      if(authController.storeStatus == 0.4){
                        ...
                        if(fName.isEmpty) {
                          ...
                          data.addAll(RestaurantBodyModel(
                            ...
                            lat: locationController.restaurantLocation!.latitude.toString(),
                            email: email,
                            lng: locationController.restaurantLocation!.longitude.toString(),
                            fName: fName,
                            lName: lName,
                            phone: phoneWithCountryCode,
                            password: password,
                            zoneId: locationController.zoneList![locationController.selectedZoneIndex!].id.toString(),
                            cuisineId: cuisines,
                          ).toJson());
