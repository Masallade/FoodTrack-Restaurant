...
import 'package:stackfood_multivendor_restaurant/features/dinning/dinning_product_view_widget.dart';
...
class DinningRestaurantScreen extends StatefulWidget {
  const DinningRestaurantScreen({super.key});

  @override
  State<DinningRestaurantScreen> createState() => _DinningRestaurantScreenState();
}

class _DinningRestaurantScreenState extends State<DinningRestaurantScreen> with TickerProviderStateMixin {
              ...
              SliverToBoxAdapter(child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  if (_tabController!.index == 0) {
                    return DinningProductViewWidget(scrollController: _scrollController, type: restController.type, onVegFilterTap: (String type) {
